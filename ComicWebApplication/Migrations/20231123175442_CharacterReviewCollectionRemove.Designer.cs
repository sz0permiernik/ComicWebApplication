...
namespace ComicWebApplication.Migrations
{
    ...
    [Migration("20231123175442_CharacterReviewCollectionRemove")]
    partial class CharacterReviewCollectionRemove
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ComicWebApplication.Models.CharacterReview", b =>
                {
                    b.HasOne("ComicWebApplication.Models.Character", "Character")
                        .WithOne("Reviews")
                        .HasForeignKey("ComicWebApplication.Models.CharacterReview", "CharacterID");
